...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.logout_button.setGeometry(QtCore.QRect(10, 200, 130, 32))
...
class MainApp(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def add_description(self):
        ...
        if ok:
            ...
            QtWidgets.QMessageBox.information(self, "Succès", "Description ajoutée avec succès.")
...
#             cursor.execute(query, (self.selected_date, description))
#             conn.commit()
#             self.show_events()  # Actualiser la liste des événements après l'ajout
#             QtWidgets.QMessageBox.information(self, "Succès", "Description ajoutée avec succès.")
    ...
    def submit_form(self):
        if self.selected_date:
            ...
            QtWidgets.QMessageBox.information(self, "Succès", "Formulaire soumis avec succès.")
        else:
            QtWidgets.QMessageBox.warning(self, "Erreur", "Veuillez sélectionner une date dans le calendrier.")
